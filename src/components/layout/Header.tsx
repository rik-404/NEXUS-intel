...
import { Shield, Clock, Bell, Sparkles, LogOut, CheckCircle2, AlertTriangle } from 'lucide-react';
  ...
  return (
    <>
      <header className="h-16 border-b border-slate-800 bg-slate-900/80 backdrop-blur-md px-6 flex items-center justify-between sticky top-0 z-30">
        ...
        {/* Right controls: RBAC Role Simulator & User Profile & Session Status */}
        <div className="flex items-center space-x-4">
          {/* Active Session Status Badge */}
          <div className="hidden lg:flex items-center space-x-2 px-2.5 py-1 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-semibold">
